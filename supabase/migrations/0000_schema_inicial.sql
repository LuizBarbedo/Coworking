-- 0000: esquema-base anterior ao versionamento (era o supabase/schema.sql).
-- Em produção JÁ ESTÁ aplicado — existe aqui pra que o supabase db reset
-- (homologação) reconstrua o banco do zero na ordem certa. Idempotente.
